    ...
    if base_seleccionada:
        ...
        if tabla_seleccionada:
            ...
            with col1.form("form_insertar"):
                ...
                # Función para guardar en log.json
...
# Mostrar encabezado
st.title("Visualización de últimos registros agregados")

# Mostrar los últimos 5 registros (los más recientes arriba)
st.info("🕒 Últimos registros agregados al log:")
for entrada in reversed(log_registros[-5:]):
